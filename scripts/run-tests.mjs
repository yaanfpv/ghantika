...
export function parseArgs(argv) {
  const options = {
    ...
    // both times in what was then test/modern-handshake.test.ts's
    // negative-control tests, now test/modern-handshake-contention-
    // timing.test.ts after a later extraction moved them (a different
    // specific sub-test each time - "initialize-gate" and "parse-error reply" -
