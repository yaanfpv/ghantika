 ...
 * it proves an original member alive, and before the SIGKILL syscall
 * actually runs, that member can exit and the numeric pgid can become
 * reusable - the check and the signal are two separate syscalls, and
